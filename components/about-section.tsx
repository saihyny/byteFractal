...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-20 px-6" style={{ backgroundColor: "#0f1419" }}>
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold mb-6 text-white">About ByteFractal</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            <div className="parallax relative w-full h-80 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl backdrop-blur-md border border-white/10 overflow-hidden">
              <Image
                src="/placeholder.svg?height=400&width=600&text=Modern+Tech+Office"
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-white mb-4">Building Tomorrow's Digital Infrastructure</h3>
